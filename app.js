...
async function search_Ip_Address(ip_address) {
  const api_key = 'at_2rHfZqnVfkQhWJQooHxgromJBMwrb';
  ...
  create_map(location.lat, location.lng, location.country, location.region, ip_address);
}
...
let map;
function create_map(lat, lng, country, region, ip) {
